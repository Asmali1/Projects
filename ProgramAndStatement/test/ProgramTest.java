 ...
 *
 * @author Wayne Heym
 * @author Donovan Liao, Mohamed Asmali, Joseph Daprano
 *
 */
public abstract class ProgramTest {

    /**
     * The names of files containing a BL program.
     */
    private static final String FILE_NAME_1 = "data/program-sample.bl";
    private static final String FILE_NAME_2 = "data/empty-program.bl";
     ...
     */
    @Test
    public final void testNameNonDefault() {
        /*
         * Setup
         */
    ...
    @Test
    public final void testNameDefault() {
        /*
         * Setup
         */
     ...
     */
    @Test
    public final void testSetNameDefaultToNonDefault() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_2);
     ...
     */
    @Test
    public final void testNewContextNonDefault() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_1);
    ...
    @Test
    public final void testNewContextDefault() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_2);
     ...
     */
    @Test
    public final void testSwapContextFirstAndRest() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_1);
     ...
     */
    @Test
    public final void testNewBodyNonDefault() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_1);
    ...
    @Test
    public final void testNewBodyDefault() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_2);
     ...
     */
    @Test
    public final void testSwapBodyFirstAndRest() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_1);

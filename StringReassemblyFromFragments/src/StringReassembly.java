...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        /*
         * returns the combination of str1 and str2, by concatinating str1's
         * substring from index 0 to index str1.length() subtracted by overlap
         * with str2
         */
        return str1.substring(0, str1.length() - overlap).concat(str2);
    }
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
         ...
         */
        /*
         * boolean value foundString is setup so that this method will not do
         * anything to strSet if the string was found somewhere in the set
         */
        boolean foundString = false;
        /*
         * for each loop will loop through all the string values in strSet to
         * check if any of them are in str. if they are in str, then foundString
         * will be true
         */
        ...
        /*
         *
         * if foundString is false, this loop will proceed. strSet will add the
         * string str. Each time element is equal to str or if str does not
         * appear in element,(str.indexOf(element)) returns a negative, then
         * set2 will add element. set2 transfers to strSet and is cleared.
         */
        if (!foundString) {
            strSet.add(str);
            Set<String> set2 = new Set1L<>();
            for (String element : strSet) {
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        Set<String> stringSet = new Set1L<>();
        /*
         * loop continues as long as input is not at the end of its stream.
         * stringSet and the nextline of input will be sent to the
         * addToSetAvoidingSubstrings to avoid any substrings of the set from
         * being duplicated in stringSet
         */
        while (!input.atEOS()) {
            addToSetAvoidingSubstrings(stringSet, input.nextLine());
        }
    ...
    public static void printWithLineSeparators(String text, SimpleWriter out) {
        ...
        int i = 0;
        /*
         * checks every character in text to see if any are the character "~".
         * If that character is found, then a new line will be printed.
         * otherwise, the character at index i in text will be printed normally
         */
        while (i < text.length()) {
            if (text.charAt(i) == '~') {
                out.println();

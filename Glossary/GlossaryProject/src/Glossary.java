...
public final class Glossary {
    ...
    public static void outputDefinition(String definition, SimpleWriter out,
        ...
        for (int i = 0; i < words.length; i++) {
            /**
             * this loop checks every single character in words[i] to check
             * they're their characters. Any non-characters like commas,
             * slashes, etc, will be removed.
             */
             ...
             */
            if (contains) {
                out.print("<a href=" + word.toString() + ".html>" + words[i]
                        + "</a>" + " ");
            } else {
                out.print(words[i] + " ");
            }

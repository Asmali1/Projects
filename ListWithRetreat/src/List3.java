...
public class List3<T> extends ListSecondary<T> {
    ...
    public final T removeRightFront() {
        ...
        //updates rightLength
        this.rightLength--;
        //removes old right front
        Node beingRemoved = this.lastLeft.next;
        //sets lastLeft's reference to beingRemoved "next" reference
        this.lastLeft.next = beingRemoved.next;
        //lastLeft becomes previous value of it's next reference's previous reference.
        this.lastLeft.next.previous = this.lastLeft;
        //data value being returned

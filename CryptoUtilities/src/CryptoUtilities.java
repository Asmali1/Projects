...
public final class CryptoUtilities {
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        n.increment();
        /*
         * witness starts off as false
         */
        boolean witness = false;
        /*
         * one will be used to compare the returned value to 1.
         */
        NaturalNumber one = n.newInstance();
        one.setFromInt(1);
        /*
         * two will be used for the first power mod check which is: w^2 mod n.
         */
        NaturalNumber two = n.newInstance();
        two.setFromInt(2);
        /*
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        if (n.compareTo(new NaturalNumber2(THREE)) <= 0) {
            ...
            /*
             * copyN is copied from n and decremented to set up the interval.
             * the randomWitness value will be set up to be between 1 and n-1.
             */
            NaturalNumber copyN = n.newInstance();
            copyN.copyFrom(n);
            copyN.decrement();
            ...
            final int fifty = 50;
            /*
             * the amount of witness candidates generated
             */

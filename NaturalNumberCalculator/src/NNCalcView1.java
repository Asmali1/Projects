...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        /*
         * loop adds a value to index i in bDigits by converting the current i
         * to a string.
         */
         ...
         */
        /*
         * final int variables created to avoid CheckStyle "magic numbers" bugs
         */
    ...
    public void registerObserver(NNCalcController controller) {
        /*
         * registers controller as observer/listener
         */
    ...
    public void updateTopDisplay(NaturalNumber n) {
        /*
         * updates the top displayw as n to a string since the .setText instance
    ...
    public void updateBottomDisplay(NaturalNumber n) {
        /*
         * updates the bottom display as n to a string since the .setText
         * instance method takes a string parameter
         */
    ...
    public void updateSubtractAllowed(boolean allowed) {
        /*
         * if allowed is true, the subtract button is enabled, otherwise it's
         * disabled.
         */
        if (allowed) {
    ...
    public void updateDivideAllowed(boolean allowed) {
        /*
         * if allowed is true, the divide button is enabled, otherwise it's
         * disabled.
         */
        if (allowed) {
    ...
    public void updatePowerAllowed(boolean allowed) {
        /*
         * if allowed is true, the power button is enabled, otherwise it's
         * disabled.
         */
    ...
    public void updateRootAllowed(boolean allowed) {
        /*
         * if allowed is true, the Root button is enabled, otherwise it's
         * disabled.
         */
        if (allowed) {

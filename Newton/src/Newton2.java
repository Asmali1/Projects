 ...
 * using Newton's iteration. Program is updated version of Newton1 to allow 0 to
 * be returned, instead the static method not returning any values(because of
 * the undefined error when dividing anything by 0.
 *
